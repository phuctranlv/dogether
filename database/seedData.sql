...
COPY tasks (taskid, task, note, current, share, userid, username) FROM 'tasksData.txt';

COPY similartasks (taskid, task, note, current, share, userid, username) FROM 'tasksData.txt';
